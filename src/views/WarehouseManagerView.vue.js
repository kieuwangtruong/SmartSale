...
__VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)({
    ...{ class: "full-width-tables-container" },
});
...
for (const [p] of __VLS_vFor((__VLS_ctx.visibleProducts))) {
    ...
    __VLS_asFunctionalElement1(__VLS_intrinsics.button, __VLS_intrinsics.button)({
        ...{ onClick: (...[$event]) => {
                ...
                // @ts-ignore
                [resetReceipt, addReceiptItem, visibleProducts, inventoryDraft, inventoryDraft, saveInventory,];
            } },
    ...
    if (item.status === 'Draft') {
        __VLS_asFunctionalElement1(__VLS_intrinsics.button, __VLS_intrinsics.button)({
            ...{ onClick: (...[$event]) => {
                    ...
                    // @ts-ignore
                    [receipts, totalPages, currentPage, confirmReceipt,];
                } },
            ...{ class: "primary" },
        });
        /** @type {__VLS_StyleScopedClasses['primary']} */ ;
