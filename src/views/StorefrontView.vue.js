...
__VLS_asFunctionalElement1(__VLS_intrinsics.a, __VLS_intrinsics.a)({
    ...{ onClick: (...[$event]) => {
            ...
            ;
            // @ts-ignore
            [category, category, showAllProducts, showAllProducts,];
        } },
    href: "#",
    ...{ class: ({ active: !__VLS_ctx.category && __VLS_ctx.showAllProducts }) },
});
...
for (const [cat] of __VLS_vFor((__VLS_ctx.categories))) {
    __VLS_asFunctionalElement1(__VLS_intrinsics.a, __VLS_intrinsics.a)({
        ...{ onClick: (...[$event]) => {
                ...
                ;
                // @ts-ignore
                [category, category, showAllProducts, showAllProducts, categories,];
            } },
        key: (cat),
        href: "#",
...
/** @type {__VLS_StyleScopedClasses['theme-toggle']} */ ;
__VLS_asFunctionalElement1(__VLS_intrinsics.i)({
    ...{ class: (__VLS_ctx.isDark ? 'pi pi-sun' : 'pi pi-moon') },
});
__VLS_asFunctionalElement1(__VLS_intrinsics.button, __VLS_intrinsics.button)({
    ...{ onClick: (...[$event]) => {
            __VLS_ctx.showCart = true;
            // @ts-ignore
            [toggleDarkMode, isDark, showCart,];
        } },
    ...{ class: "cart-button" },
...
if (!__VLS_ctx.category && !__VLS_ctx.showAllProducts) {
    ...
    __VLS_asFunctionalElement1(__VLS_intrinsics.a, __VLS_intrinsics.a)({
        ...{ onClick: (...[$event]) => {
                ...
                ;
                // @ts-ignore
                [category, category, showAllProducts, showAllProducts, animateCart, cartCount,];
            } },
        ...{ class: "primary-cta" },
        href: "#products",
    });
    ...
    __VLS_asFunctionalElement1(__VLS_intrinsics.small, __VLS_intrinsics.small)({});
    __VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)({
        ...{ class: "floating-card bottom-card" },
    });
    /** @type {__VLS_StyleScopedClasses['floating-card']} */ ;
    /** @type {__VLS_StyleScopedClasses['bottom-card']} */ ;
    __VLS_asFunctionalElement1(__VLS_intrinsics.i)({
    ...
    for (const [slide, index] of __VLS_vFor((__VLS_ctx.slides))) {
        ...
        __VLS_asFunctionalElement1(__VLS_intrinsics.button, __VLS_intrinsics.button)({
            ...{ onClick: (...[$event]) => {
                    ...
                    ;
                    // @ts-ignore
                    [category, category, showAllProducts, showAllProducts, availableProducts, products, slides, activeSlide,];
                } },
            ...{ class: "slide-btn" },
            type: "button",
        });
...
if (!__VLS_ctx.category && !__VLS_ctx.showAllProducts) {
    ...
    if (__VLS_ctx.loading) {
        ...
        for (const [product] of __VLS_vFor((__VLS_ctx.featuredProducts))) {
            ...
            if (product.quantity > 0) {
                __VLS_asFunctionalElement1(__VLS_intrinsics.small, __VLS_intrinsics.small)({
                    ...{ class: (product.quantity <= product.reserveStock ? 'low-stock-text' : 'in-stock-text') },
                });
                __VLS_asFunctionalElement1(__VLS_intrinsics.i)({
                    ...{ class: "pi pi-check-circle" },
                });
    ...
    if (__VLS_ctx.search) {
        ...
        __VLS_asFunctionalElement1(__VLS_intrinsics.i)({
            ...{ onClick: (...[$event]) => {
                    ...
                    __VLS_ctx.search = '';
                    // @ts-ignore
                    [category, visibleProducts, search, search, search, search,];
                } },
            ...{ class: "pi pi-times" },
            ...{ style: {} },
        });
        ...
        for (const [product] of __VLS_vFor((__VLS_ctx.paginatedProducts))) {
            __VLS_asFunctionalElement1(__VLS_intrinsics.article, __VLS_intrinsics.article)({
                ...{ onClick: (...[$event]) => {
                        ...
                        __VLS_ctx.openProductDetail(product);
                        // @ts-ignore
                        [openProductDetail, visibleProducts, clearFilters, paginatedProducts,];
                    } },
                key: (product.id),
                ...{ class: "product-card" },
            });
...
if (__VLS_ctx.selectedProduct) {
    ...
    for (const [image, idx] of __VLS_vFor((__VLS_ctx.getProductImages(__VLS_ctx.selectedProduct)))) {
        __VLS_asFunctionalElement1(__VLS_intrinsics.button, __VLS_intrinsics.button)({
            ...{ onClick: (...[$event]) => {
                    ...
                    // @ts-ignore
                    [totalPages, currentPage, selectedProduct, selectedProduct, selectedProduct, selectedProduct, selectedProduct, selectedProduct, selectedProduct, closeProductDetail, closeProductDetail, getProductImages, getProductImages, getProductImages, selectedImageIndex, selectedImageIndex, selectedImageIndex,];
                } },
            key: (idx),
            type: "button",
    ...
    __VLS_asFunctionalElement1(__VLS_intrinsics.button, __VLS_intrinsics.button)({
        ...{ onClick: (...[$event]) => {
                ...
                // @ts-ignore
                [formatCurrency, selectedProduct, selectedProduct, selectedProduct, selectedProduct, selectedProduct, selectedProduct, selectedProduct, selectedProduct, selectedProduct, productDetailQuantity, productDetailQuantity,];
            } },
        type: "button",
    ...
    __VLS_asFunctionalElement1(__VLS_intrinsics.button, __VLS_intrinsics.button)({
        ...{ onClick: (...[$event]) => {
                ...
                // @ts-ignore
                [selectedProduct, selectedProduct, productDetailQuantity, productDetailQuantity, productDetailQuantity,];
            } },
        type: "button",
...
__VLS_asFunctionalElement1(__VLS_intrinsics.button, __VLS_intrinsics.button)({
    ...{ onClick: (...[$event]) => {
            ...
            // @ts-ignore
            [showCart, showCart, cartCount, selectedProduct, closeProductDetail, addToCartFromDetail,];
        } },
    type: "button",
    'aria-label': "Đóng",
});
    ...
    for (const [line] of __VLS_vFor((__VLS_ctx.cart))) {
        ...
        __VLS_asFunctionalElement1(__VLS_intrinsics.button, __VLS_intrinsics.button)({
            ...{ onClick: (...[$event]) => {
                    ...
                    // @ts-ignore
                    [formatCurrency, cart, changeQuantity,];
                } },
            type: "button",
            'aria-label': "Giảm số lượng",
        });
...
if (__VLS_ctx.showCheckout) {
    __VLS_asFunctionalElement1(__VLS_intrinsics.div)({
        ...{ onClick: (...[$event]) => {
                ...
                // @ts-ignore
                [formatCurrency, cart, cartTotal, openCheckoutModal, showCheckout, showCheckout,];
            } },
...
if (__VLS_ctx.showPaymentConfirm) {
    __VLS_asFunctionalElement1(__VLS_intrinsics.div)({
        ...{ onClick: (...[$event]) => {
                ...
                // @ts-ignore
                [cartCount, formatCurrency, cartTotal, requestPaymentConfirmation, customerForm, customerForm, customerForm, customerForm, checkoutError, checkoutError, checkoutLoading, checkoutLoading, showPaymentConfirm, showPaymentConfirm,];
            } },
...
if (__VLS_ctx.showPaymentConfirm) {
    ...
    __VLS_asFunctionalElement1(__VLS_intrinsics.button, __VLS_intrinsics.button)({
        ...{ onClick: (...[$event]) => {
                ...
                // @ts-ignore
                [checkoutError, checkoutError, showPaymentConfirm, showPaymentConfirm,];
            } },
        type: "button",
        disabled: (__VLS_ctx.checkoutLoading),
    });
