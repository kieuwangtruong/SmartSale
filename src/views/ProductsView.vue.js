...
for (const [p] of __VLS_vFor((__VLS_ctx.visible))) {
    ...
    __VLS_asFunctionalElement1(__VLS_intrinsics.span, __VLS_intrinsics.span)({
        ...{ class: ({ warning: p.quantity <= p.reserveStock }) },
    });
    ...
    if (__VLS_ctx.canManageProducts) {
        __VLS_asFunctionalElement1(__VLS_intrinsics.button, __VLS_intrinsics.button)({
            ...{ onClick: (...[$event]) => {
                    ...
                    __VLS_ctx.edit(p);
                    // @ts-ignore
                    [canManageProducts, reset, reset, reset, reset, form, form, form, form, form, showCategoryModal, showCategoryModal, addCategory, categoryName, visible, formatCurrency, edit,];
                } },
        });
    }
