...
.chatbot-head {
  ...
  border: 0 !important;
  background: linear-gradient(135deg, #0f766e 0%, #14877e 100%) !important;
  color: #ffffff !important;
}
...
.chatbot-body {
  ...
  background: linear-gradient(180deg, #f8fafc 0%, #eef6f5 100%) !important;
  display: flex !important;
  flex-direction: column !important;
  gap: 12px !important;
...
.chatbot-input input {
  ...
  padding: 0 16px !important;
  border-radius: 999px !important;
  border: 1px solid #d6e2e0 !important;
  background: #f8fafc !important;
  color: #1e293b !important;
  font-size: 13px !important;
}
...
/* Chatbot form: cleaner assistant style */
.chatbot-panel {
  border: 0 !important;
  border-radius: 16px !important;
  background: #ffffff !important;
...
.chatbot-head {
  ...
  background: linear-gradient(135deg, #1269ff 0%, #05b5ff 100%) !important;
  overflow: hidden !important;
}
...
.chatbot-suggestions button {
  ...
  background: #ffffff !important;
  border: 1.5px solid #1269ff !important;
...
.chatbot-input button {
  ...
  background: #1269ff !important;
  box-shadow: 0 12px 28px rgba(18, 105, 255, 0.3) !important;
}

.chatbot-input button:hover:not(:disabled) {
  background: #0057ea !important;
}
